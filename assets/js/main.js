...
sr.reveal(`.home__perfil, .about__image, .contact__mail, .about__shadow`, {origin: 'right'})
sr.reveal(`.home__name, .home__info
           .about__container .section__title-1, .about__info, .contact__social, .contact__data, .home__description`, {origin: 'left'})

sr.reveal(`.services__card, .projects__card`, {inteval: 100})
